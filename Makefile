# ====================================================================================
# Setup Project
PROJECT_NAME := provider-driftprovider
...
XPKGS = provider-driftprovider
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-driftprovider: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider DriftProvider CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider DriftProvider controllers
...
# This target prepares repo for your provider by replacing all "driftprovider"
